public class PatientAdulte extends Patient {
    ...
    public PatientAdulte(double coefficientFatigue, double beta) {
    ...
    public void evoluerReponseImmunitaire() {
        ...
        double nouvelleActivite = activiteImmunitaire + beta * chargeTotal - coefficientFatigue * activiteImmunitaire;
